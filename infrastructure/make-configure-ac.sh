...
AC_SUBST([PACKAGE_VERSION_MAJOR],[%s])
AC_DEFINE([PACKAGE_VERSION_MAJOR],["%s"],[package version major number])

AC_SUBST([PACKAGE_VERSION_MINOR],[%s])
AC_DEFINE([PACKAGE_VERSION_MINOR],["%s"],[package version minor number])

AC_SUBST([PACKAGE_VERSION_PATCH],[%s])
AC_DEFINE([PACKAGE_VERSION_PATCH],["%s"],[package version patch number])
...
"${tree_MAJOR_VERSION}" "${tree_MAJOR_VERSION}"                 \
"${tree_MINOR_VERSION}" "${tree_MINOR_VERSION}"                 \
