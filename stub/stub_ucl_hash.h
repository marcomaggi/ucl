...
ucl_decl void ucl_hash_extract (ucl_hash_table_t this, ucl_hash_entry_t *entry_p);
ucl_decl ucl_hash_entry_t * ucl_hash_find (const ucl_hash_table_t this, const ucl_value_t key);
ucl_decl ucl_hash_entry_t * ucl_hash_first (const ucl_hash_table_t this);
ucl_decl void ucl_hash_enlarge (ucl_hash_table_t this);
ucl_decl void ucl_hash_restrict (ucl_hash_table_t this);
ucl_decl void ucl_hash_iterator (const ucl_hash_table_t this, ucl_iterator_t iterator);
ucl_decl size_t ucl_hash_number_of_used_buckets (const ucl_hash_table_t this);
ucl_decl size_t ucl_hash_bucket_chain_length (const ucl_hash_table_t this, ucl_vector_index_t position);
ucl_decl double ucl_hash_average_search_distance (const ucl_hash_table_t this);
...
typedef void ucl_hash_extract_proto_t (ucl_hash_table_t this, ucl_hash_entry_t *entry_p);
typedef ucl_hash_entry_t * ucl_hash_find_proto_t (const ucl_hash_table_t this, const ucl_value_t key);
typedef ucl_hash_entry_t * ucl_hash_first_proto_t (const ucl_hash_table_t this);
typedef void ucl_hash_enlarge_proto_t (ucl_hash_table_t this);
typedef void ucl_hash_restrict_proto_t (ucl_hash_table_t this);
typedef void ucl_hash_iterator_proto_t (const ucl_hash_table_t this, ucl_iterator_t iterator);
typedef size_t ucl_hash_number_of_used_buckets_proto_t (const ucl_hash_table_t this);
typedef size_t ucl_hash_bucket_chain_length_proto_t (const ucl_hash_table_t this, ucl_vector_index_t position);
typedef double ucl_hash_average_search_distance_proto_t (const ucl_hash_table_t this);
