...
typedef ucl_block_t ucl_vector_block_from_range_proto_t (ucl_vector_t self, ucl_range_t range);
typedef ucl_range_t ucl_vector_range_from_block_proto_t (ucl_vector_t self, ucl_block_t block);
