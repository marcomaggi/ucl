...
ucl_decl void ucl_quicksort (void *const pbase, size_t total_elems, size_t size, ucl_value_comparison_t cmp);
...
typedef void ucl_quicksort_proto_t (void *const pbase, size_t total_elems, size_t size, ucl_value_comparison_t cmp);
