...
ucl_decl void ucl_vector_set_compar (ucl_vector_t self, ucl_comparison_t compar);
...
typedef void ucl_vector_set_compar_proto_t (ucl_vector_t self, ucl_comparison_t compar);
