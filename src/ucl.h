/*
   ...
   Copyright (c)  2001-2010  Marco Maggi <marcomaggi@gna.org>
...
typedef ucl_vector_config_tag_t *	ucl_vector_config_t;
...
typedef ucl_vector_tag_t *		ucl_vector_t;
...
extern void ucl_graph_initialise_dfs_handle (ucl_graph_dfs_t * search_handle);
...
extern void ucl_vector_initialise__config (ucl_vector_config_t config,
					   size_t slot_dimension,
					   size_t number_of_slots);
extern void ucl_vector_initialise_config_buffer (ucl_vector_config_t config);
extern ucl_vector_t ucl_vector_alloc (ucl_vector_config_t config);
...
extern void ucl_hash_initialise (ucl_hash_table_t this,
				   ucl_value_comparison_t compar,
				   ucl_hash_t hash);
extern void ucl_hash_constructor (ucl_hash_table_t this);
extern void ucl_hash_destructor (ucl_hash_table_t this);
