...
stub(2005-09-23-18-09-42) const char *
ucl_version (void)
{
  return PACKAGE_VERSION;
}
stub(2005-09-23-18-09-46) const char *
ucl_major_version (void)
{
  return PACKAGE_VERSION_MAJOR;
}
stub(2005-09-23-18-09-49) const char *
ucl_minor_version (void)
{
  return PACKAGE_VERSION_MINOR;
}
stub(2005-09-23-18-09-53) const char *
ucl_patch_version (void)
{
  return PACKAGE_VERSION_PATCH;
}
stub(2005-09-26-17-34-15) unsigned
ucl_interface_major_version (void)
{
  return ucl_INTERFACE_MAJOR_VERSION;
}
stub(2005-09-26-17-35-45) unsigned
...
/* The following is a modified  version of "stdlib/qsort.c" from the GNU
   C Library version 2.4. */
