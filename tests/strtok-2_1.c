/* strtok-2_1.c --
   ...
   $Id: strtok-2_1.c,v 1.1.1.1 2003/12/11 07:56:13 marco Exp $
*/
...
test (void)
{
  ...
  assert(strPtr->ptr);
  ucl_strtok_duplicate(strPtr1, strPtr);
  assert(strPtr1->ptr);

  assert(ucl_strtok_compare(strPtr, strPtr1) == 0);
	    
  ucl_strtok_destructor(strPtr);
  ucl_strtok_destructor(strPtr1);
}
